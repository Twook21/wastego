    ...
    <div className="bg-white dark:bg-gray-900 transition-colors duration-200">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center ">
          <motion.h1 className="text-4xl font-bold mb-6" variants={fadeIn}>
            Tentang WasteGo
          </motion.h1>
          <motion.p
          ...
          >
            Inovasi teknologi dalam pengelolaan sampah untuk Indonesia yang
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <motion.div
              className="bg-gray-50 dark:bg-gray-800 p-8 rounded-lg border shadow-lg border-gray-300"
              variants={cardAnimation}
              whileHover={{ y: -8, transition: { duration: 0.3 } }}
            >
              <h3 className="text-2xl font-semibold text-teal-900 dark:text-white mb-4">
                Visi
              </h3>
              <p className="text-gray-600 dark:text-gray-300">
                Menjadi platform pengelolaan sampah terdepan yang menghubungkan
                masyarakat, pengumpul sampah, dan industri daur ulang untuk
                menciptakan ekosistem pengelolaan sampah yang efisien dan
                berkelanjutan.
              </p>
            </motion.div>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span>
                    Mengedukasi masyarakat tentang pentingnya pemilahan dan
                    pengelolaan sampah
                  </span>
                </motion.li>
                <motion.li
                ...
                >
                  ...
                  <span>
                    Memfasilitasi pengumpulan sampah dengan teknologi yang mudah
                    diakses
                  </span>
                </motion.li>
                <motion.li
                ...
                >
                  ...
                  <span>
                    Meningkatkan kesejahteraan pengumpul sampah melalui sistem
                    yang adil
                  </span>
                </motion.li>
                <motion.li
                ...
                >
                  ...
                  <span>
                    Mendorong ekonomi sirkular melalui daur ulang dan pengolahan
                    sampah
                  </span>
                </motion.li>
              </motion.ul>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
          ...
          <motion.div
            className="bg-white dark:bg-gray-700 p-8 rounded-lg border shadow-lg border-gray-300"
          ...
          >
            ...
            >
              <p>
                WasteGo didirikan pada tahun 2025 oleh 5 orang mahasiswa{" "}
                <strong>Politeknik Elektronika Negri Surabaya (PENS)</strong>{" "}
                yang peduli dengan masalah pengelolaan sampah di Indonesia.
                Diawali dengan proyek kecil di kampus, kami melihat potensi
                teknologi untuk mengubah cara masyarakat berinteraksi dengan
                sampah mereka.
              </p>
              <p className="mt-4">
                Melalui riset mendalam dan kolaborasi dengan berbagai pihak,
                kami mengembangkan aplikasi yang tidak hanya memudahkan
                pengumpulan sampah, tetapi juga memberikan edukasi dan insentif
                bagi pengguna untuk berpartisipasi aktif dalam menjaga
                kebersihan lingkungan.
              </p>
              <p className="mt-4">
                Saat ini, WasteGo telah berkembang menjadi platform yang
                menghubungkan ribuan rumah tangga dengan pengumpul sampah
                terdekat, dan berkolaborasi dengan industri daur ulang untuk
                memaksimalkan nilai dari sampah yang dikumpulkan.
              </p>
            </motion.div>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              ...
              >
                <span className="text-2xl font-bold text-teal-900 dark:text-teal-900">
                  1
                </span>
              </motion.div>
              <h3 className="text-xl font-semibold text-teal-900 dark:text-white mb-3">
                Jadwalkan
              </h3>
              <p className="text-gray-600 dark:text-gray-300">
                Jadwalkan pengambilan sampah melalui aplikasi. Pilih waktu yang
                nyaman dan kategori sampah yang akan diambil.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Pengumpul sampah terdekat akan datang pada waktu yang
                ditentukan. Anda dapat melacak kedatangan mereka secara
                real-time.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Pantau kontribusi Anda terhadap lingkungan melalui statistik
                pengurangan emisi karbon dan sampah yang terdaur ulang.
              </p>
            </motion.div>
          </motion.div>
        </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-bold text-teal-900 dark:text-lime-500 mb-3">
              Tim Kami
            </h2>
            <motion.div
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <motion.p
            ...
            variants={fadeIn}
          >
            Bersama-sama, kita dapat menciptakan Indonesia yang lebih bersih dan
          ...
          >
            ...
            >
              <Link
                to="/download"
                className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-teal-900 bg-lime-500 dark:bg-lime-500 dark:text-teal-900 hover:bg-opacity-90"
              >
                Download Aplikasi
              </Link>
            </motion.div>
