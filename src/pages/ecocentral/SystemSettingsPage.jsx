...
const SystemSettingsPage = () => {
  ...
  const [wasteCategories, setWasteCategories] = useState([
    ...
    { id: 6, name: 'Elektronik', color: '#EC4899', icon: '📱', isActive: false },
  ]);
  ...
  const saveCategory = () => {
    if (editingCategory) {
      setWasteCategories(wasteCategories.map(cat => 
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
        ...
        <div className="p-4 md:p-6">
          ...
          {activeTab === 'notifications' && (
            ...
            >
              <div className="mb-6">
                <h2 className="text-lg font-medium text-gray-800 dark:text-white mb-4">Pengaturan Notifikasi Global</h2>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Konfigurasi notifikasi yang akan diterima oleh semua pengguna platform. Pengaturan ini akan mengganti preferensi individual.
                </p>
              </div>
                ...
                <ul className="divide-y divide-gray-200 dark:divide-gray-700">
                  ...
                  <motion.li variants={fadeIn}>
                    <div className="px-4 py-4 sm:px-6 flex items-center justify-between">
                      <div>
                        <h3 className="text-sm font-medium text-gray-900 dark:text-white">Kontribusi Baru</h3>
                  ...
                  <motion.li variants={fadeIn}>
                    <div className="px-4 py-4 sm:px-6 flex items-center justify-between">
                      <div>
                        <h3 className="text-sm font-medium text-gray-900 dark:text-white">Update Sistem</h3>
                        <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  ...
                  <motion.li variants={fadeIn}>
                    <div className="px-4 py-4 sm:px-6 flex items-center justify-between">
                      <div>
                        <h3 className="text-sm font-medium text-gray-900 dark:text-white">Pencapaian</h3>
                        <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                          Notifikasi saat pengguna mencapai milestone atau badge baru
                        </p>
                      </div>
                      <button
                  ...
                  <motion.li variants={fadeIn}>
                    <div className="px-4 py-4 sm:px-6 flex items-center justify-between">
                      <div>
                        <h3 className="text-sm font-medium text-gray-900 dark:text-white">Aktivitas Marketplace</h3>
                        <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                          Notifikasi terkait transaksi dan aktivitas di marketplace
                        </p>
                      </div>
                      <button
                        onClick={() => toggleNotification('marketplaceActivity')}
                        className={`p-1 rounded-full ${
                  ...
                  <motion.li variants={fadeIn}>
                    <div className="px-4 py-4 sm:px-6 flex items-center justify-between">
                      <div>
                        <h3 className="text-sm font-medium text-gray-900 dark:text-white">Acara Komunitas</h3>
                        <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  ...
                  <motion.li variants={fadeIn}>
                    <div className="px-4 py-4 sm:px-6 flex items-center justify-between">
                      <div>
                        <h3 className="text-sm font-medium text-gray-900 dark:text-white">Laporan Mingguan</h3>
                        <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  ...
                  <motion.li variants={fadeIn}>
                    <div className="px-4 py-4 sm:px-6 flex items-center justify-between">
                      <div>
                        <h3 className="text-sm font-medium text-gray-900 dark:text-white">Peringatan Pemeliharaan</h3>
                        <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  ...
                  <motion.li variants={fadeIn}>
                    <div className="px-4 py-4 sm:px-6 flex items-center justify-between">
                      <div>
                        <h3 className="text-sm font-medium text-gray-900 dark:text-white">Promosi Partner</h3>
                        <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
              ...
              <div className="mt-6 bg-blue-50 dark:bg-blue-900 dark:bg-opacity-20 rounded-md p-4">
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <h3 className="text-sm font-medium text-blue-800 dark:text-blue-400">Tentang Notifikasi</h3>
                    <div className="mt-2 text-sm text-blue-700 dark:text-blue-300">
                      <p>
                        Pengaturan ini mempengaruhi seluruh sistem. Pengguna masih dapat menyesuaikan preferensi notifikasi mereka secara individual melalui menu pengaturan akun mereka.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          {activeTab === 'app-config' && (
            ...
            >
              <div className="mb-6">
                <h2 className="text-lg font-medium text-gray-800 dark:text-white mb-4">Konfigurasi Aplikasi</h2>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Sesuaikan pengaturan tampilan dan fungsionalitas aplikasi EcoBuddy
                </p>
              </div>
              
              <div className="bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-md mb-6">
                <div className="p-4 sm:p-6 border-b border-gray-200 dark:border-gray-700">
                  <h3 className="text-base font-medium text-gray-900 dark:text-white">Tampilan</h3>
                </div>
                ...
                <ul className="divide-y divide-gray-200 dark:divide-gray-700">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between">
                        ...
                        <div className="flex items-center space-x-3">
                          <select
                            ...
                            className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-teal-500 focus:border-teal-500 sm:text-sm rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                          >
                  ...
                  <motion.li variants={fadeIn}>
                    <div className="px-4 py-4 sm:px-6">
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between">
                        <div className="mb-2 sm:mb-0">
                          <h4 className="text-sm font-medium text-gray-900 dark:text-white">Warna Utama</h4>
                          <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  ...
                  <motion.li variants={fadeIn}>
                    <div className="px-4 py-4 sm:px-6">
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between">
                        <div className="mb-2 sm:mb-0">
                          <h4 className="text-sm font-medium text-gray-900 dark:text-white">Bahasa</h4>
                          <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                  ...
                  <motion.li variants={fadeIn}>
                    <div className="px-4 py-4 sm:px-6">
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between">
                        <div className="mb-2 sm:mb-0">
                          <h4 className="text-sm font-medium text-gray-900 dark:text-white">Format Tanggal</h4>
                          <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
              ...
              <div className="bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-md">
                <div className="p-4 sm:p-6 border-b border-gray-200 dark:border-gray-700">
                  <h3 className="text-base font-medium text-gray-900 dark:text-white">Aksesibilitas & Preferensi</h3>
                </div>
                ...
                <ul className="divide-y divide-gray-200 dark:divide-gray-700">
                  <motion.li variants={fadeIn}>
                    <div className="px-4 py-4 sm:px-6 flex items-center justify-between">
                      <div>
                        <h4 className="text-sm font-medium text-gray-900 dark:text-white">Tampilkan Tutorial</h4>
                        <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                          Menampilkan petunjuk penggunaan untuk pengguna baru
                        </p>
                      </div>
                      <button
                        onClick={() => setAppConfig({...appConfig, showTutorials: !appConfig.showTutorials})}
                        className={`p-1 rounded-full ${
                  ...
                  <motion.li variants={fadeIn}>
                    <div className="px-4 py-4 sm:px-6 flex items-center justify-between">
                      <div>
                        <h4 className="text-sm font-medium text-gray-900 dark:text-white">Aktifkan Animasi</h4>
                        <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                          Mengaktifkan animasi dan transisi di antarmuka
                        </p>
                      </div>
                      <button
                        onClick={() => setAppConfig({...appConfig, enableAnimations: !appConfig.enableAnimations})}
                        className={`p-1 rounded-full ${
                  ...
                  <motion.li variants={fadeIn}>
                    <div className="px-4 py-4 sm:px-6 flex items-center justify-between">
                      <div>
                        <h4 className="text-sm font-medium text-gray-900 dark:text-white">Mode Kontras Tinggi</h4>
                        <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                          Meningkatkan kontras untuk aksesibilitas yang lebih baik
                        </p>
                      </div>
                      <button
                        onClick={() => setAppConfig({...appConfig, highContrastMode: !appConfig.highContrastMode})}
                        className={`p-1 rounded-full ${
                  ...
                  <motion.li variants={fadeIn}>
                    <div className="px-4 py-4 sm:px-6 flex items-center justify-between">
                      <div>
                        <h4 className="text-sm font-medium text-gray-900 dark:text-white">Mode Kompak</h4>
                        <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                          Menampilkan lebih banyak informasi dalam ruang yang lebih kecil
                        </p>
                      </div>
                      <button
                        onClick={() => setAppConfig({...appConfig, compactMode: !appConfig.compactMode})}
                        className={`p-1 rounded-full ${
              ...
              <div className="mt-6 flex justify-end">
                <button
                  className="mr-3 inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 shadow-sm text-sm font-medium rounded-md text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500"
                >
                  Batalkan Perubahan
                </button>
                <button
