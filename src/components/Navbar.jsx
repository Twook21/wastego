          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="-mr-2 flex md:hidden">
              <button
                ...
                className="inline-flex items-center justify-center p-2 rounded-md text-gray-700 dark:text-white hover:bg-teal-600 dark:hover:bg-gray-700 focus:outline-none"
              >
                <svg
                  className="h-6 w-6"
      ...
      {isMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link to="/" className="block px-3 py-2 rounded-md text-base dark:text-white font-medium hover:bg-teal-600 dark:hover:bg-gray-700 hover:text-lime-400">
              Beranda
            </Link>
            <Link to="/about" className="block px-3 py-2 rounded-md text-base dark:text-white font-medium hover:bg-teal-600 dark:hover:bg-gray-700 hover:text-lime-400">
              Tentang
            </Link>
            <Link to="/download" className="block px-3 py-2 rounded-md text-base dark:text-white font-medium hover:bg-teal-600 dark:hover:bg-gray-700 hover:text-lime-400">
              Download
            </Link>
